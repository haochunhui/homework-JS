 function javascript(){
     ...
     var swrap=document.getElementById("slider");//定义整个幻灯片区域为swrap
     var cursors=document.getElementById("snav").getElementsByTagName("li");//定义索引数组为cursor
     var imgs=document.getElementById("scont").getElementsByTagName("li");//定义图片数组为imgs
